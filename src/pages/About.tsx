            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              <div>
                ...
                <p className="text-gray-600 mb-6">
                  I'm an AI architect, which is just a fancy way of saying I design and build complex systems that help people solve real-world problems using artificial intelligence. I'm the founder of Kontrak IQ, an enterprise contract data management platform powered by a vertical AI Agent. My expertise sits at the intersection of systems and software development.
                </p>
                <p className="text-gray-600 mb-6">
